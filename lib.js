...
// use firebase storage to store an image and get the download url v9.6.10
 
async function uploadFile (file, folder, name,func=()=>{}){ 
  const storage = getStorage();
  const storageRef = ref(storage, folder+'/'+name);
  
   
  // create new promese to return the download url
